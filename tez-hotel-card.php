...
class ZU_Tez_Hotel_Card_OneFile {
  ...
  private function print_assets_once() {
    ...
    add_action('wp_footer', function () {
      ...
      .hotel-slider{position:relative;border-radius:14px;overflow:hidden;background:#f8fafc}
      .hotel-slide{display:none;position:relative}
      .hotel-slide.is-active{display:block}
      .hotel-card .hotel-slide img{width:100%;max-width:100%;height:auto;display:block;border-radius:14px;object-fit:cover}
